...
describe CsvLoader do
  ...
  describe "#new" do
    ...
    context "with valid input old" do
    ...
    context "with inval input old" do
      it "should not generate an error" do
    ...
    context "with duplicate input old" do
      it "should generate an error" do
  ...
  describe "#num_valid_rec" do
    context "when loading valid old" do
    ...
    context "when loading old with errors" do
      it "reports the correct number of successful records" do
    ...
    context "when re-loading identical old" do
    ...
    context "when there is existing old, and loading new old" do
  ...
  describe "#warning_message" do
    ...
    context "when loading old with warnings" do
