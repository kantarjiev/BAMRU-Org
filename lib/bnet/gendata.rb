        ...
        csv_text =
          [
           "kind,title,leaders,begin_date,begin_time,finish_date,finish_time,location,lat,lon,description",
            "meeting,C1:Meeting   #{x1},Lead1,#{d1},Loc1,37.7207,-122.0962,Desc C1",
           "training,C2:Training  #{x2},\"Lead2A, Lead2B\",#{d2},Loc2",
           "training,C3:Training  #{x3},\"Lead3A,B,C\",#{d3},TBA,,,Desc C3",
           "training,C4:Training  #{x4},Lead4,#{d4}",
           "training,C5:Training  #{x5},TBA,#{d5},Loc5,,,Desc C5",
           "training,C6:Training  #{x6},,#{d6},Loc6",
           "training,C7:Training  #{x7},TBA,#{d7},TBA,'','',Desc C7",
          "community,C8:Community #{x8},TBA,#{d8},,37.7207,-122.0962",
          ].join("\n")
      end
